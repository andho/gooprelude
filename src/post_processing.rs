use bevy::{
    ...
    core_pipeline::{
        ...
        fullscreen_vertex_shader::fullscreen_shader_vertex_state, core_2d,
    },
    prelude::*,
    render::{
        extract_component::{
...
impl Plugin for PostProcessPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins((
            ...
            .register_type::<PostProcessSettings>();
...
#[derive(Component, Default, Clone, Copy, ExtractComponent, ShaderType, Reflect, InspectorOptions)]
pub struct PostProcessSettings {
    #[inspector(min = 0.1, max = 0.5)]
    pub intensity: f32,
}
